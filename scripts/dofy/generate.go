...
//go:generate go run go.uber.org/mock/mockgen -source=internal/infrastructure/ansible.go -destination=./gen/mock/infrastructure/ansible.go
...
//go:generate go run github.com/cweill/gotests/gotests -all -exported -parallel -w -excl New.+ -template_dir internal/test/templates internal/infrastructure/ansible.go
